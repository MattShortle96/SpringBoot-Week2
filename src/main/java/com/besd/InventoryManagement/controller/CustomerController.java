package com.besd.InventoryManagement.controller;
...
import com.besd.InventoryManagement.service.CustomerService;
...
public class CustomerController {
	...
	public ResponseEntity<Object> deleteCustomer(@PathVariable Long id){
		try {
			...
			return new ResponseEntity<Object>("Deleted customer with ID: " + id, HttpStatus.OK);
		}catch(Exception e) {
			return new ResponseEntity<Object>(e.getMessage(), HttpStatus.NOT_FOUND);
		}
	}
